                        ...
                        <div class="row">
                            <div class="col-lg-6">
                                <div class="form-group focused">
                                    ...
                                    <input type="text" id="input-produk" name="name" class="form-control form-control-alternative" placeholder="Nama Produk">
                                </div>
                            </div>
                            <div class="col-lg-6">
                                <div class="form-group">
                                    <label class="form-control-label" for="input-harga">Harga Umum</label>
                                    <input name="general_price" type="text" id="input-harga" class="form-control form-control-alternative" placeholder="Contoh :  70000">
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-lg-6">
                                <div class="form-group focused">
                                    ...
                                    <input type="text" name="description" id="input-deskripsi" class="form-control form-control-alternative" placeholder="Deskripsi">
                                </div>
                            </div>
                            <div class="col-lg-6">
                                <div class="form-group focused">
